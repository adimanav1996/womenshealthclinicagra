    ...
    <body>
        ...
        <nav class="navbaar" id="navbar">
            <div >
                ...
                <a target="_blank" href="https://form.jotform.com/202577545508461"><li>Online Appointment</li></a>
		   <!--https://drive.google.com/open?id=1jTUFEUfX1MnimQfseMGgk75IxKNmPBPS -->
            </div>
        </nav>
     <script>
